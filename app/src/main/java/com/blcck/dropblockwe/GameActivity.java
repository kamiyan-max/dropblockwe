...
public class GameActivity extends Activity implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    final Shape[] shapes = new Shape[26];
    ...
    private void ShapesInit() {
        ...
        a[1][2] = a[3][2] = 1;
        shapes[10] = new Shape(a, Color.rgb(255,160,31), BoardCell.BEHAVIOR_IS_FALLING);
        a[1][2] = a[3][2] = 0;

        a[1][2] = a[4][2] = 1;
        shapes[11] = new Shape(a, Color.rgb(255,255,113), BoardCell.BEHAVIOR_IS_FALLING);
        a[1][2] = a[4][2] = 0;

        a[1][2] = a[2][2] = a[4][2] = 1;
        shapes[12] = new Shape(a, Color.rgb(150,150,150), BoardCell.BEHAVIOR_IS_FALLING);
        a[1][2] = a[2][2] = a[4][2] = 0;
        //たて終了

        a[1][2] = a[3][2] = a[2][1] = 1;
        shapes[13] = new Shape(a, Color.rgb(50,150,150), BoardCell.BEHAVIOR_IS_FALLING);
        a[1][2] = a[3][2] = a[2][1] = 0;
        //T型終わり

        a[1][2] = a[2][2] = a[2][1] = 1;
        shapes[14] = new Shape(a, Color.rgb(50,255,150), BoardCell.BEHAVIOR_IS_FALLING);
        a[1][2] = a[2][2] = a[2][1] = 0;

        a[1][2] = a[2][1] = 1;
        shapes[15] = new Shape(a, Color.rgb(50,100,50), BoardCell.BEHAVIOR_IS_FALLING);
        a[1][2] = a[2][1] = 0;
        //しかく終わり

        a[1][2] = a[2][2] = a[3][3] = 1;
        shapes[16] = new Shape(a, Color.rgb(105, 100, 0), BoardCell.BEHAVIOR_IS_FALLING);
        a[1][2] = a[2][2] = a[3][3] = 0;

        a[1][2] = a[3][3] = 1;
        shapes[17] = new Shape(a, Color.rgb(200, 150, 0), BoardCell.BEHAVIOR_IS_FALLING);
        a[1][2] = a[3][3] = 0;

        a[1][3] = a[2][3] = a[3][2] = 1;
        shapes[18] = new Shape(a, Color.rgb(80, 0, 0), BoardCell.BEHAVIOR_IS_FALLING);
        a[1][3] = a[2][3] = a[3][2] = 0;

        a[1][3] = a[3][2] = 1;
        shapes[19] = new Shape(a, Color.rgb(82, 0, 46), BoardCell.BEHAVIOR_IS_FALLING);
        a[1][3] = a[3][2] = 0;

        //L

        a[2][1] = a[2][3] = a[1][3] = 1;
        shapes[20] = new Shape(a, Color.rgb(255, 0, 79), BoardCell.BEHAVIOR_IS_FALLING);
        a[2][1] = a[2][3] = a[1][3] = 0;


        a[2][1] = a[2][3] = a[3][3] = 1;
        shapes[21] = new Shape(a, Color.rgb(150, 0, 255), BoardCell.BEHAVIOR_IS_FALLING);
        a[2][1] = a[2][3] = a[3][3] = 0;
        ...
        shapes[22] = new Shape(a, Color.GRAY, BoardCell.BEHAVIOR_IS_FALLING, false);
        a[1][2] = a[2][1] = a[2][2] = a[2][3] = a[3][2] = 0;

        // big cube
        for (int i = 1; i <= 4; ++i) for (int j = 1; j <= 4; ++j) a[i][j] = 1;
        shapes[23] = new Shape(a, Color.rgb(117, 101, 57), BoardCell.BEHAVIOR_IS_FALLING, false);
        for (int i = 1; i <= 4; ++i) for (int j = 1; j <= 4; ++j) a[i][j] = 0;

        //big H
        for (int i = 1; i <= 4; ++i) for (int j = 1; j <= 4; ++j) a[i][j] = 1;
        a[1][2] = a[1][3] = a[4][2] = a[4][3] = 0;
        shapes[24] = new Shape(a, Color.rgb(128, 158, 73), BoardCell.BEHAVIOR_IS_FALLING);
        for (int i = 1; i <= 4; ++i) for (int j = 1; j <= 4; ++j) a[i][j] = 0;

        a[1][2] = a[2][2] = a[2][3] = a[3][2] = 1;
        shapes[25] = new Shape(a, Color.BLACK, BoardCell.BEHAVIOR_IS_FALLING);
        a[1][2] = a[2][2] = a[2][3] = a[3][2] = 0;
    }
    ...
    private boolean CreateShape() {
        ...
        if (difficulty.compareTo("Normal") == 0) {
            currentShape = shapes[random.nextInt(22)];
        } else {
